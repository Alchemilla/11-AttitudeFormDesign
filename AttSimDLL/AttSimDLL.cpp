...
//日期：2017.10.18
//////////////////////////////////////////////////////////////////////////
void attitudeDeterActivePushbroom(int totalT, int freqQ, int freqG, double BeforeAfterT[2],
	char* workpath, double *qTrueC, double *qMeasC, int isBinEKF,
	double *wTrueC, double *wMeasC, double *dqOut, double *xest_store)
{
	nQuat = totalT*freqQ;
	...
	int beforeAct = BeforeAfterT[0] * freqQ;//主动推扫前姿态个数
	int afterAct = nQuat - BeforeAfterT[1] * freqQ;//主动推扫后姿态位置
	Quat *qMeas = new Quat[beforeAct + BeforeAfterT[1] * freqQ];
	...
	nQuat = beforeAct + BeforeAfterT[1] * freqQ;
