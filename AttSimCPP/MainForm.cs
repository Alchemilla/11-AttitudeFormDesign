...
namespace AttSimCPP
{
    public partial class MainForm : Form
    {
        ...
        private void SetTabPage3Default()
        {
            ...
            textBox13.Text = "5950";//仿真起始时间
            textBox14.Text = "6050";//仿真结束时间
            textBox26.Text = "6009";//成像起始时间
            textBox27.Text = "6031";//成像结束时间
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            mAtt.freqG = Convert.ToInt32(textBox17.Text);//string转数值的第1种转换方式
             //工作时间
            mAtt.startT = double.Parse(textBox13.Text);
            mAtt.endT = double.Parse(textBox14.Text);
            //成像时间
            mAtt.imgTs = double.Parse(textBox26.Text);
            mAtt.imgTe = double.Parse(textBox27.Text);
            //星敏参数
